...
<span style="color: blue"> 此外，本小组与樊文飞院士（[主页](https://docs.qq.com/pdf/DVFR5aFZma0pUT21h)）联合招收数据库方向博士研究生（培养地深圳），欢迎有意向的同学联系我。樊文飞院士团队研究方向主要围绕数据库、大数据计算、数据质量与半结构化数据管理。主要包括：
...
欢迎有意向该方向的同学联系我，也可直接将简历、本科成绩单和排名证明、英语水平证明及获奖和成果证明等材料发送至报名咨询邮箱：zhuangxipan@sics.ac.cn </span>
