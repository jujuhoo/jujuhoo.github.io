...
I am looking for highly motivated and self-driven master students, who are interested in  query processing, data mining, and machine learning.
...
Conference Paper
------
<span style="color: red"> (RecSys 26, CCF-B)</span> <span style="color: blue">Give the Long-tail More SPACE: Promoting Provider Fairness in Next POI Recommendation</span> <br />  Anran Zhang, Jiaqi Jiang, **Jiahui Jin**, Yuhan Zhao. in Proceedings of The 20th ACM Conference on Recommender Systems
 (RecSys), 2026.
...
Journal Paper
------
1. <span style="color: red"> (TKDD 26, CCF-B)</span><span style="color: blue"> Integrating Heterogeneous Spatio-Temporal Interactions for Traffic Speed Prediction.</span><br /> Xigang Sun, **Jiahui Jin**, Haojia Zhu, Wenchao Bai, Xin Lin. ACM Transactions on Knowledge Discovery from Data (TKDD), 2026 
